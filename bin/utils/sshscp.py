...
RSYNC_EXCLUDE = (" --exclude .git " + 
                ...
                " --exclude examples " +
                " --exclude m-explore-ros2 " + 
                " --exclude rmit-cosc2781-teaching ")
...
class SshScp:
    ...
    def rsyncFiles(self, src, dest, sudo=False, chmod=None, local_hostname=None):
        ...
        fullCommand = fullCommand + append + src + " " + hostname + ":" + dest
        echo.print_subitem(fullCommand)
